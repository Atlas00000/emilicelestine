      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <Badge className="bg-blue-600/20 text-blue-400 border-blue-500/30 px-4 py-2">Professional Journey</Badge>
          </div>
            ...
            <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm h-full">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white">Hello, I'm Celestine</h3>
                </div>
              ...
              >
                <Card className="bg-gray-900/50 border-gray-800 hover:border-blue-500/50 transition-all duration-300 backdrop-blur-sm h-full">
                  <CardContent className="p-6 text-center">
                    <div
                      className={`w-12 h-12 mx-auto mb-4 bg-gradient-to-br ${highlight.color} rounded-full flex items-center justify-center`}
                    >
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Key milestones that shaped my career</p>
          </div>
              ...
              >
                <div className={`w-5/12 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8"}`}>
                  <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-300">
                    <CardContent className="p-4">
                      <Badge className="bg-blue-600 text-white mb-2">{item.year}</Badge>
                ...
                <div className="relative">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-4 h-4 bg-blue-500 rounded-full border-4 border-black z-10 relative"
                  />
                </div>
