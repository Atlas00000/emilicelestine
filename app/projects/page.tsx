  ...
  const projects: Project[] = [
    {
      ...
      impact: "Helping 500+ users access mental health resources",
    ...
    },
    {
      ...
      name: "Luxenest",
      description:
        "A modern, luxury real estate listing platform with responsive design, map integration, and dynamic property browsing.",
      longDescription:
        "Premium real estate platform featuring advanced property search algorithms, interactive maps with neighborhood insights, virtual tours, and comprehensive property management tools. Built with modern web technologies for optimal performance and user experience in the luxury real estate market.",
      tech: ["React", "Node.js", "MongoDB", "Express", "Mapbox", "Stripe", "Socket.io"],
      category: ["Full-Stack", "Real Estate", "E-commerce"],
      ...
      impact: "Managing $2M+ in property listings",
    ...
    },
    {
      id: "shared-voices",
      name: "Shared Voices",
      description: "A platform to elevate underrepresented perspectives using blogs, forums, and user-curated content.",
      longDescription:
      ...
      github: "https://github.com/celestine/shared-voices",
      image: "/placeholder.svg?height=400&width=600",
      status: "Live",
      year: "2023",
      features: [
    ...
    },
    {
      ...
      name: "Skillcraft",
      description:
        "A job/internship platform for artisans and creatives with interactive user onboarding and role-based access.",
      longDescription:
        "Specialized job platform connecting skilled artisans with opportunities. Features comprehensive skill verification, portfolio showcases, project-based hiring system, and integrated payment solutions for freelance work in the creative industry.",
      tech: ["React", "Node.js", "MongoDB", "Socket.io", "Stripe", "Cloudinary"],
      category: ["Full-Stack", "Job Platform", "Creative"],
      ...
      impact: "Connecting 300+ artisans with opportunities",
